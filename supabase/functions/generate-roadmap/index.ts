...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `You are an expert learning path designer. Create comprehensive, structured learning roadmaps for tech subjects. Return data in a format suitable for visual node-based representation with proper positioning.

Create a detailed learning roadmap for: ${subject}
