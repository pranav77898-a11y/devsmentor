...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a job search assistant specializing in tech jobs in India. Generate realistic job listings based on current market trends. Include a mix of full-time positions and internships from real companies.`;
...
Requirements:
- Include mix of startups and established companies (Google, Microsoft, Flipkart, Razorpay, etc.)
