...
import { Sparkles, Mail, Lock, User, Loader2, Eye, EyeOff, Check } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: 'Welcome to DevMentor AI!',
      });
      navigate('/career');
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden px-4 py-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="glow-orb glow-orb-primary w-[400px] h-[400px] -top-20 -right-20 animate-float" />
        <div className="glow-orb glow-orb-secondary w-[300px] h-[300px] bottom-20 -left-20 animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-2xl font-bold gradient-text">DevMentor AI</span>
        </Link>

        {/* Signup Card */}
        <div className="glass-card p-8">
          <h1 className="text-2xl font-bold text-center mb-2">Create Account</h1>
          <p className="text-muted-foreground text-center mb-8">Start your tech career journey today</p>
